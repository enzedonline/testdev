        ...
        if (this.toolbar) {
            try {
                ...
                <svg viewBox="0 0 16 16">
                    <text xml:space="preserve" style="font-family:'Segoe UI';letter-spacing:-1.33px;display:inline;fill:#currentColor;stroke:none;stroke-width:80;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:3.6;stroke-opacity:1">
                        <tspan x="-0.15" y="10.5""><tspan style="font-size:14px;letter-spacing:-1.33px;fill:#currentColor">A</tspan><tspan style="font-size:12px;letter-spacing:-1.33px;fill:#currentColor">b</tspan></tspan>
                    </text>
