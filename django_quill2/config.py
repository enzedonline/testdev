...
DEFAULT_CONFIG = {
    ...
    'modules': {
        ...
        # quill-image-reducer - resize images with width/height attributes
        'image-reducer': {
        ...
        'toolbar': {
            'container': [
                ...
                [{'insert-better-table-plus': []}, {'list': 'ordered'}, {'list': 'bullet'}],
                ['blockquote', 'code-block'],
                ['link', 'image', 'image-reducer', 'video'],
                [{'color': []}, {'background': []}],
                ['clean']
            ],
            'handlers': {
...
MEDIA_CSS = [
    ...
    # quill-better-table
    static("css/quill/quill-better-table-plus.css"),
    # quill-insert-better-table-plus
...
TOOLBAR_LABELS = [
    ...
    ('.ql-picker.ql-header .ql-picker-label:not([data-value])::before, .ql-picker.ql-header .ql-picker-item:not([data-value])::before', _("Normal")),
]